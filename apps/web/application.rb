...
module Web
  class Application < Hanami::Application
    configure do
      ...
      # AJM - this is based on the example shown here: http://katafrakt.me/2017/05/02/neat-authentication-for-hanami/
      # AJM - these are the gem files installed: 
      # gem 'omniauth-github'
      # gem 'warden'
      # gem 'scrypt'
      ...
      middleware.use OmniAuth::Builder do
        provider :hanami, repository: ProviderRepository
